    ...
    if(!err){
      ...
      cleanRepositories.forEach(function(item,index){
        getLanguage(item.full_name, function(languages){
          ...
          if (typeof callback == 'function' && repositories.length == cleanRepositories.length){
